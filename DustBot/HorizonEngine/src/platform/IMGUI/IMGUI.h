...
namespace ImGui
{
	...
	IMGUI_API ImVec2        CalcTextSize(const float fontSize, const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f);
